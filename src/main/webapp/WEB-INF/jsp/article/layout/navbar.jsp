			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-6 col-lg-4 col-md-3 col-sm-6 logo-wrapper">
					<a href="${contextRoot}/" class="logo"> <img
						src="${contextRoot}/img/picwish.png" alt="" style="height: 80px;">
					</a>
				</div>
					...
					<div class="right-button">
						<ul>
							...
							<li><a class="btn-login"
								href="${contextRoot}/member/loginHome">登入</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto mr-auto">
							...
							<li class="nav-item"><a class="nav-link"
								href="${contextRoot}/article">專欄</a></li>
							<li class="nav-item"><a class="nav-link"
								href="${contextRoot}/location/locationList">精選地點</a></li>
							<li class="nav-item submenu dropdown"><a
								href="${contextRoot}/discussion/showAllDiscussion"
								class="nav-link dropdown-toggle">討論區</a></li>
							<li class="nav-item"><a class="nav-link"
								href="${contextRoot}/actandles">活動與課程</a></li>
							<li class="nav-item"><a class="nav-link"
								href="${contextRoot}/shop/index">商城</a></li>
