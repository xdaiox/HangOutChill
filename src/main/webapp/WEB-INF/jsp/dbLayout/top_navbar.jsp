...
=======
        <a class="navbar-brand brand-logo" href="index.html"><img src="${contextRoot}/img/dashboard/picwish.png" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="${contextRoot}/img/dashboard/picwish.png" alt="logo"/></a>
>>>>>>> ray
      </div>
...
=======
              <img src="${contextRoot}/img/dashboard/user.png" alt="profile"/>
>>>>>>> ray
            </a>
