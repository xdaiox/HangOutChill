            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form:form modelAttribute="updateMember" method="PUT" action="${contextRoot}/back/backUpdateMember">
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-2 col-form-label">會員性別</label>
                            <div class="col-sm-10">
                                <jstl:choose>
