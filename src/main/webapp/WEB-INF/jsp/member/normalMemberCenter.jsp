                    ...
                    <div class="aside-body">
                        <div class=" btn-group-vertical my-3" >
                            <ul>
                                ...
                                <li class="btn btn-primary btn-lg" style=" background: #9C84BC;border: #c8cbcf 0px;"><a href="${contextRoot}/actandles/MemberCenter"  style="color: azure;" >我的活動</a></li>
                                <li class="btn btn-secondary btn-lg" style="background: #E1E3E5; border: #c8cbcf 0px ;" ><jstl:choose>
                                    <jstl:when test="${result.role.roleId == 1}">
                                        <a href="${contextRoot}/normalMember/showFavoriteLocation" style="color: #7455bb">我的地點</a>
                                    </jstl:when>
                                    <jstl:otherwise>
                                        <a href="${pageContext.request.contextPath}/location/memberLocationInfo/locationManager" style="color: #7455bb;">我的地點</a>
                                    </jstl:otherwise>
                                </jstl:choose></li>
