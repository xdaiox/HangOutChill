...
<div class="box-wrapper">
    <div class="box box-border">
        <div class="box-body">
            <h4>商家註冊</h4>
            <form:form action="${contextRoot}/LocationMember/registed" method="post" modelAttribute="newLocationMember" enctype="multipart/form-data" id="NewMemberForm" onsubmit="checked(event);">
                <div class="form-group">
                    <label class="fw">帳號 (信箱)<span id="wrongMail" style="color: red"></span></label>
                    <form:input path="account" type="email" class="form-control" name="account" id="account" onblur="checkMail()"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="fw">商家聯絡人真實姓名<span id="wrongNickname" style="color: red"></span></label>
                    <form:input path="nickName" type="text" name="nickname" class="form-control" id="nickName"/>
                </div>
                <div class="form-group">
                    <label class="fw">商家名稱<span id="wrongName" style="color: red"></span></label>
                    <form:input  path="reallName" type="text" name="realname" class="form-control" id="realname"/>
                </div>
                <div class="form-group">
                    <label class="fw">聯絡人性別</label>
                    <label>男
                ...
                <div class="form-group">
                    <label class="fw">聯絡人手機<span id="wrongTel" style="color: red"></span></label>
                    <form:input path="tel" type="text" name="tel" class="form-control" id="phone"/>
                </div>
                <div class="form-group">
                    <label class="fw">聯絡人出生年月日<span id="wrongDate" style="color: red"></span></label>
                    <form:input  path="birthdate" type="date" name="birthdate" class="form-control" id="date"/>
                </div>
                <div class="form-group">
                    <label class="fw">商家大頭貼</label>
