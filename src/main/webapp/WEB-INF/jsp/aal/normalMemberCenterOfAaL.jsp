				...
				<div class="col-md-9">
					<div class="col-md-12">
								...
								<jstl:when test="${result.role.roleId==1}">
									<div class="card">
										<div class="card-header"
											style="text-align: center; font-size: 20px;">報名紀錄</div>
										<div class="card-body">
													...
													<tbody>
														<jstl:forEach var="signup" items="${signup.content}">
															<tr>
																...
																<td class="align-middle" style="display: flex;"><jstl:if
																		test="${signup.checkedout>0}">
																		<button disabled class="btn btn-primary">已完成付款</button>
																		<a
																			href="${contextRoot}/actandles/detail/showorder?aalid=${signup.id}">
																			<button type="button" class="btn btn-primary">查看紀錄</button>
																		</a>
																	</jstl:if> <jstl:if test="${signup.checkedout==0}">
									...
									<div class="card">
										<div class="card-header"
											style="text-align: center; font-size: 20px;">交易紀錄</div>
										<div class="card-body">
											<div class="table-responsive">
												<table class="table table-hover table-bordered table-light">
													<thead>
						...
						<jstl:when test="${result.role.roleId==3}">
							<p style="text-align: center; font-size: 25px;">請前往後臺管理↑
						</jstl:when>
						</jstl:choose>
